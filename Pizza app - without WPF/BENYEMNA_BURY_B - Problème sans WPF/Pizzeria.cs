...
namespace BENYEMNA_BURY_B___Problème_sans_WPF
{
    public class Pizzeria
    {
        ...
        /*Lorsque l'on créer une Pizzeria, on crée des liste vides de Commis, Commande, Livreur et Client
         * qu'on remplira dont on aura besoin d'afficher et trier leur contenu par la suite 
         */
        #endregion
        ...
        #region Propriétés
        public string NomPizzeria
        {
            get { return this.nomPizzeria; }
        }
        public string AddressePizzeria
        {
            get { return this.addressePizzeria; }
        }
        public string TelephonePizzeria
        {
            get { return this.telephonePizzeria; }
        }
        ...
        public List<Commis> Liste_commis
        {
            get { return this.liste_commis; }
        }
