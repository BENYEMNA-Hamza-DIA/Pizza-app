...
namespace BENYEMNA_BURY_B
{
                            ...
                            IComparable<Commande>//Permet le tri les commandes grâce aux interfaces existantes
    {
        ...
        public Commande(string numCommande, List<Pizza> listePizzas, List<Boisson> listeBoissons, DateTime dateCommande, string nomClient, string nomCommis, string nomLivreur)
        {
            ...
            this.facture = this.numCommande + ";" + this.dateCommande + ";" + this.nomClient + ";" + this.nomCommis + ";" + this.nomLivreur + ";" + this.etat + ";" + this.solde;
            this.prix = this.PrixSansPromo() + " euros";
        }
        public Commande(string numCommande, List<Pizza> listePizzas, List<Boisson> listeBoissons, DateTime dateCommande, string nomClient)
        {
            this.numCommande = numCommande;
            this.listePizzas = listePizzas;
            this.listeBoissons = listeBoissons;
            this.dateCommande = dateCommande;
            this.nomClient = nomClient;
            this.nomCommis = "Non assigné";
            this.nomLivreur = "Non assigné";
            this.etat = "En préparation";
            this.solde = "non paye";
            this.facture = this.numCommande + ";" + this.dateCommande + ";" + this.nomClient + ";" + this.nomCommis + ";" + this.nomLivreur + ";" + this.etat + ";" + this.solde;
            this.prix = this.PrixSansPromo() + " euros";
        }
        public Commande(string numCommande, List<Pizza> listePizzas, List<Boisson> listeBoissons, DateTime dateCommande, string nomClient, string nomCommis, string nomLivreur, string etat, string solde)
        {
            this.numCommande = numCommande;
            this.listePizzas = listePizzas;
            this.listeBoissons = listeBoissons;
        ...
        #endregion
        #region Propriétes
        public string Prix { get => this.prix; set => this.prix = value; }
        public string NumCommande { get => numCommande; }
        public List<Pizza> ListePizzas { get => listePizzas; }
        public List<Boisson> ListeBoissons { get => listeBoissons; }
        public DateTime DateCommande { get => dateCommande; }
        public string NomClient { get => nomClient; set => this.nomClient = value; }
        public string NomCommis { get => nomCommis; set => this.nomCommis = value; }
        public string Etat { get => etat; }
        public string Solde { get => solde; }
        public string Facture { get => facture; }
        public string NomLivreur { get => nomLivreur; set => this.nomClient = value; }
        #endregion
        #region Methodes
        ...
        {
            this.listeBoissons.Add(boisson);
        }
        public void SupprimerPizza()
        {
            if (this != null && this.listePizzas.Count != 0)
            {
                this.listePizzas.RemoveAt(this.listePizzas.Count - 1);
            }
        }
        public void SupprimerBoisson()
        {
            if (this != null && this.listePizzas.Count != 0)
            {
                this.listeBoissons.RemoveAt(this.listeBoissons.Count - 1); ;
            }
